      ...
      <div className="bg-[var(--theme-bg)] text-[var(--theme-text)] pb-12 relative w-full">
            ...
            <div className="relative z-10">
              ...
              <div className="flex gap-4 flex-1 justify-start px-6 w-full">
                {coupsDeCoeur.map((film, i) => (
                  <button key={i} onClick={() => setSelectedFilm(film)}
                    ...
                    <div className="relative" style={{ paddingTop: 20, paddingLeft: 16, paddingRight: 16 }}>
                      {i === 0 && (
                        <>
                          <ChubbyHeart className="absolute text-white drop-shadow-lg z-20 pointer-events-none" style={{ top: -2, left: -2, width: 52, height: 52, transform: 'rotate(-18deg)' }} />
                          <ChubbyHeart className="absolute text-white drop-shadow-md z-20 pointer-events-none" style={{ top: 18, left: -14, width: 34, height: 34, transform: 'rotate(-28deg)', opacity: 0.9 }} />
                          <ChubbyHeart className="absolute text-white drop-shadow-md z-20 pointer-events-none" style={{ bottom: 30, left: -12, width: 40, height: 40, transform: 'rotate(12deg)', opacity: 0.85 }} />
                        </>
                      )}
                      {i === 1 && (
                        <ChubbyHeart className="absolute text-white drop-shadow-lg z-20 pointer-events-none" style={{ top: -2, right: -2, width: 52, height: 52, transform: 'rotate(18deg)' }} />
                      )}
        ...
        <section className="relative py-12 overflow-hidden">
          ...
          <div className="px-6 flex items-start gap-4">
            <span className="font-galinoy flex-shrink-0" style={{ fontSize: '3rem', color: 'var(--theme-accent)', lineHeight: 1 }}>{voPct}%</span>
            <div className="flex flex-col text-right w-full">
              <p className="font-outfit text-[var(--theme-text)] font-semibold text-[18px] leading-tight mb-1">Hello! Ciao! Guten Tag!</p>
            ...
            <div className="pl-20 pr-6 text-right">
              {topRoom && (
                <div className="mb-8">
                  ...
                  <span className="font-galinoy block" style={{ fontSize: '2rem', color: 'var(--theme-accent)', lineHeight: 1.1 }}>{topRoom[0]}</span>
              ...
              {favoriteSeat && (
                <div>
                  ...
                  <span className="font-galinoy block" style={{ fontSize: '2rem', color: 'var(--theme-accent)', lineHeight: 1.1 }}>{favoriteSeat[0]}</span>
                  <p className="font-outfit text-[12px] mt-2 leading-relaxed ml-auto" style={{ opacity: 0.55, maxWidth: '70%' }}>
                    Cela correspond à <span className="font-semibold" style={{ color: 'var(--theme-text)', opacity: 1 }}>{seatSharePct}%</span> de tes séances à cette place.
                  </p>
                </div>
              )}
            </div>
            ...
            <section className="relative py-12 overflow-hidden">
              <div className="flex items-start gap-0 px-6">
                <div className="flex-1 flex flex-col pr-6" style={{ minWidth: 0 }}>
                  <p className="font-outfit text-[var(--theme-text)] text-[12px] opacity-60 uppercase mb-5 tracking-wider">Ton dernier film à cette période :</p>
                  <p className="font-outfit text-[var(--theme-text)] font-bold text-[22px] leading-snug mb-8">Il semblerait que tu trouves le plus souvent le chemin du cinéma</p>
                  <div className="inline-flex items-center gap-3 rounded-full px-4 py-2 self-start" style={{ backgroundColor: 'var(--theme-accent)' }}>
                    <div className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#1a1a2e' }}>
                ...
                {lastFilmOnFavDay && (
                  <div className="flex-shrink-0 rounded-[18px] overflow-hidden"
                    style={{ width: 200, height: 300, marginRight: -80, transform: 'rotate(3deg)', boxShadow: '0 8px 32px rgba(0,0,0,0.28)', background: '#D9D9D9', flexShrink: 0 }}>
          ...
          <div className="relative z-10 px-6 pt-10 pb-12" style={{ backgroundColor: '#7E0000' }}>
            ...
            {isNonCapucinesMonth ? (
              <div className="flex flex-col gap-1 mb-6 w-2/3">
                <span className="font-outfit text-white text-[18px]">En <span className="font-semibold">{periodLabel}</span></span>
              ...
              <>
                <div className="flex flex-col gap-1 mb-6 w-2/3">
                  ...
                  <div className="flex items-baseline gap-3">
                    ...
                    <span className="font-outfit text-white text-[18px]">film{capucinesTotalForPeriod > 1 ? 's' : ''} en compétition</span>
                  </div>
                </div>
        ...
        <section className="py-16 px-6 flex flex-col items-center text-center">
          <p className="font-outfit uppercase tracking-[0.18em] text-[11px] mb-5"
          ...
          <p className="font-outfit text-[var(--theme-text)] text-[19px] leading-snug mb-8" style={{ maxWidth: '26ch' }}>
            Quelle aventure que cette période <span className="font-semibold">{dashView === 'all' ? 'Global' : periodLabel}</span> !
          </p>
          <div className="w-full h-px mb-8" style={{ backgroundColor: 'color-mix(in srgb, var(--theme-border) 25%, transparent)' }} />
          {dashView === 'all' ? (
            <p className="font-outfit italic text-[13px] leading-relaxed mb-8"
            ...
            <p className="font-outfit text-[14px] leading-relaxed mb-8"
          ...
          <button
            ...
            style={{
              borderColor: dashView === 'all' ? 'color-mix(in srgb, var(--theme-text) 18%, transparent)' : 'var(--theme-text)',
              color: dashView === 'all' ? 'color-mix(in srgb, var(--theme-text) 25%, transparent)' : 'var(--theme-text)',
